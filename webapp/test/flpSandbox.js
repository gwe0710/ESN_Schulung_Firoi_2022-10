		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Kunden",
									"targetURL": "#atclouddnastudent06zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnastudent06zhoui5-display": {
								"semanticObject": "atclouddnastudent06zhoui5",
								"action": "display",
								"description": "Kundenapplikation (GWe)",
								"title": "Kunden",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.student06.zhoui5",
									"url": sap.ui.require.toUrl("at/clouddna/student06/zhoui5")
								}
							}
						}
					}
